...
if ($result->num_rows > 0) {
    ...
    $sql_insert = "INSERT INTO checking_transactions (transid, trans_date, trans_type, trans_amount) VALUES ('$transid', '$trans_date', '$trans_type', '$trans_amount')";
    ...
    $sql_update = "UPDATE checking SET Balance='$newBalance' WHERE Acct_no='$transid'";
